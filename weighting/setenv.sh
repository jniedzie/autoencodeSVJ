...
. /cvmfs/sft.cern.ch/lcg/releases/tbb/2020_U2-daa7e/x86_64-centos7-gcc8-opt/tbb-env.sh
export LD_LIBRARY_PATH=/cvmfs/sft.cern.ch/lcg/releases/tbb/2020_U2-daa7e/x86_64-centos7-gcc8-opt/lib/:$LD_LIBRARY_PATH
