...
out_file_name = "trainingResults_noLeptonVeto_fatJets/aucs.txt"
...
def get_auc_for_sample(mass, rinv):
    ...
    model_output_path = "trainingResults_noLeptonVeto_fatJets/models/model_{}GeV_{:3.2f}.sav".format(mass, rinv)
