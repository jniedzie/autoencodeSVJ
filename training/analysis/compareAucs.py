...
input_paths = [
    ...
    (glob.glob("../trainingResults_debugging/aucs/efp_3_bottle_5_arch_8__8_loss_mean_absolute_error_optimizer_Adam_batchSize_256_StandardScaler_activation_elu_tiedWeights_False_epochs_200_v*"), kBlue, "(7, 7), BN: 1"),
