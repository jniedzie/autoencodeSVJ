...
input_paths = [
    (glob.glob("../trainingResults_v3/aucs/bottle_5_arch_8__8_loss_mean_absolute_error_optimizer_Adam_batchSize_256_StandardScaler_activation_elu_tiedWeights_False_epochs_200_maxJets_2_metric_accuracy_noEfp0_noPt_weighted_v*"), kBlue, "(7, 7), BN: 1"),
    (glob.glob("../trainingResults_v3/aucs/bottle_4_arch_8__8_loss_mean_absolute_error_optimizer_Adam_batchSize_256_StandardScaler_activation_elu_tiedWeights_False_epochs_200_maxJets_2_metric_accuracy_noEfp0_noPt_weighted_v*"), kBlue, "(7, 7), BN: 1"),
    (glob.glob("../trainingResults_v3/aucs/bottle_4_arch_7__7_loss_mean_absolute_error_optimizer_Adam_batchSize_256_StandardScaler_activation_elu_tiedWeights_False_epochs_200_maxJets_2_metric_accuracy_noEfp0_noPt_weighted_v*"), kBlue, "(7, 7), BN: 1"),
    (glob.glob("../trainingResults_v3/aucs/bottle_3_arch_7__7_loss_mean_absolute_error_optimizer_Adam_batchSize_256_StandardScaler_activation_elu_tiedWeights_False_epochs_200_maxJets_2_metric_accuracy_noEfp0_noPt_weighted_v*"), kBlue, "(7, 7), BN: 1"),
    (glob.glob("../trainingResults_v3/aucs/bottle_3_arch_6__6_loss_mean_absolute_error_optimizer_Adam_batchSize_256_StandardScaler_activation_elu_tiedWeights_False_epochs_200_maxJets_2_metric_accuracy_noEfp0_noPt_weighted_v*"), kBlue, "(7, 7), BN: 1"),
    (glob.glob("../trainingResults_v3/aucs/bottle_4_arch_17__17_loss_mean_absolute_error_optimizer_Adam_batchSize_256_StandardScaler_activation_elu_tiedWeights_False_epochs_200_maxJets_2_metric_accuracy_noEfp0_noPt_weighted_v*"), kBlue, "(7, 7), BN: 1"),
]
