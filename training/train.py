...
parser.add_argument("-i", "--i_sample", dest="i_sample", default=-1, type=int)
parser.add_argument("-m", "--mass", dest="mass", default=-1, type=int)
parser.add_argument("-r", "--rinv", dest="rinv", default=-1, type=int)
...
def get_sigal_name_for_index(i_sample, mass, rinv):
...
for i in range(config.n_models):
    ...
    if config.train_on_signal:
        ...
        signal_name = get_sigal_name_for_index(args.i_sample, args.mass, args.rinv)
